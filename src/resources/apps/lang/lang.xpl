...
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline"
	...
	<p:processor name="oxf:xslt">
		<p:input name="data" href="#instance" debug="xin"/>
		<p:input name="config">
			<xsl:stylesheet version="2.0">
			<xsl:import href="lang.xsl"/>
			<xsl:param name="query" select="/*/param"/>
			</xsl:stylesheet>
		</p:input>
		<p:output name="data" id="stylesheet-output" debug="xout"/>
	</p:processor>
    ...
    <p:processor name="oxf:xslt">
        ...
        <p:output name="data" id="url-generator" debug="instance"/>
    </p:processor>
    ...
    <p:choose href="#stylesheet-output">
        <p:when test="/*/xquery != ''">
            <!-- Inline XQuery -->
            <p:processor name="oxf:identity">
                <p:input name="data" href="#stylesheet-output#xpointer(/*/xquery)" debug="xquery"/>
